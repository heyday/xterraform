...
whitelisted_ips = ["0.0.0.0/0"] // Initial IPs which can access the stack. Set to ["0.0.0.0/0"] for public access
...
tasks_desired_count = 2 // Main app maximum task count, for load balancing target
